	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Mobile.LK</a>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<form method="post" action="">
					<div class="row">
						<div class="col-md-6">
							<label for="f_name">Make</label>
							<input type="text" id="f_name" name="f_name" class="form-control">
						</div>
						<div class="col-md-6">
							<label for="f_name">Model</label>
					...
					<div class="row">
						<div class="col-md-6">
							<label for="email">Price (LKR)</label>
					...
					<div class="row">
						<div class="col-md-12">
							<label for="imgae_files">Upload Images</label>
							    <input type="file" name="fileToUpload" id="imgae_files">
						</div>
					</div>
						<br>
					<div class="row">
						<div class="col-md-12">
							<label for="address1">Features</label>
